...
As outras estatísticas são as mesmas?
...
Como foi calculado o DWARFF dele?


## Posições novamente

Vamos eliminar as repetições da lista:
...
A única constante nesta temporada é que cada time da expert list tem um center.

O primeiro time tem 2 PGs.

O segundo time tem 2 SFs.

O terceiro time tem 2 PGs e 2 PFs, e nenhum S!

Realmente, não dá para considerar as posições, aparentemente.
