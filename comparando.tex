...
\emph{ranking} e retorna uma \emph{tibble} com as colunas \texttt{nome},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(ranking) \{}
...
\NormalTok{  p }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(ranking)}
  
\NormalTok{  nomes }\OtherTok{\textless{}{-}}\NormalTok{ ranking }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(nome)}
\NormalTok{  k }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(nomes }\SpecialCharTok{==} \StringTok{\textquotesingle{}x\textquotesingle{}}\NormalTok{)}
  
\NormalTok{  soma\_ }\OtherTok{\textless{}{-}}\NormalTok{ ranking }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{filter}\NormalTok{(nome }\SpecialCharTok{==} \StringTok{\textquotesingle{}{-}\textquotesingle{}}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{pull}\NormalTok{(pos\_ranking) }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{sum}\NormalTok{()}
  
\NormalTok{  (k }\SpecialCharTok{/}\NormalTok{ p) }\SpecialCharTok{+}\NormalTok{ (soma\_ }\SpecialCharTok{/}\NormalTok{ (}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ p }\SpecialCharTok{*}\NormalTok{ (p }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)))}
